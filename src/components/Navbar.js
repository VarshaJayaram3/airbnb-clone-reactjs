    ...
    <div className="border-b sticky top-0 z-50 bg-white/[95%]  ">
      <div className="flex justify-between items-center sm:mx-6 md:mx-10 lg:mx-12 ">
        ...
        <div className="  h-1  flex">
          <img src={logo} alt="Logo" className=" object-cover -my-5" />
        </div>
        {/* Middle */}
        ...
        <div className="flex items-center pr-3  font-semibold text-gray-600">
          ...
          <div >
          <Link to="/Signin" className="flex items-center border px-3 py-2 rounded-full gap-2 bg-[#ff5a60] text-white font-bold shadow-lg shadow-gray-300 hover:bg-[#f9787c] duration-100 ease-out">
            <p>Sign in</p>
